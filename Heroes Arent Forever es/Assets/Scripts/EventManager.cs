...
public class EventManager : MonoBehaviour
{
    ...
    {   
        ...
        if(RoomController.instance.currentWorldName == "Cave"){
            WorldName.GetComponentsInChildren<Text>()[0].text = "Cuevas";    
        }else if(RoomController.instance.currentWorldName == "DeepCave"){
            WorldName.GetComponentsInChildren<Text>()[0].text = "Cuevas Profundas";    
        }else if(RoomController.instance.currentWorldName == "Castle"){
            WorldName.GetComponentsInChildren<Text>()[0].text = "Castillo";    
        }
